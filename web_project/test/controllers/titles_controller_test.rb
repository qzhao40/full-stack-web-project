...
class TitlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create title" do
    assert_difference('Title.count') do
      post titles_url, params: { title: { body: @title.body, published_at: @title.published_at, user_id: @title.user_id } }
    end
  ...
  test "should update title" do
    patch title_url(@title), params: { title: { body: @title.body, published_at: @title.published_at, user_id: @title.user_id } }
